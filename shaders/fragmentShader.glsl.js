...
vec3 PT(float t) 
                                                                        {
                                                                            return vec3(.5) + vec3(.5) * cos(6.28318 * (vec3(1) * t * 0.1 + vec3(0, .33, .67)));
                                                                        }
vec3 tile(vec3 p) 
                                                                        {
...
vec3 normal(vec3 p) 
                                                                        {
                                                                            vec2 e = vec2(-1., 1.) * EPS;
                                                                            return normalize(e.yxx * map(p + e.yxx).x + e.xxy * map(p + e.xxy).x + e.xyx * map(p + e.xyx).x + e.yyy * map(p + e.yyy).x);
                                                                        }
